...
class Solution:
    def minOperations(self, nums: List[int], k: int) -> int:
        ...
        while (nums[0] < k):
            ...
            operation_result = (min(first_min, second_min) * 2) + max(first_min, second_min)
            
            operations_count += 1
            heapq.heappush(nums, operation_result)
        
        return operations_count

solution = Solution()

print(solution.minOperations([2,11,10,1,3], 10)) # Expected 2
